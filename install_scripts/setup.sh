...
install_custom_sway() {
    echo "Installing TheShortDuck customized sway..."
...
prompt_installation_choice() {
    ...
    echo "2. Install $wm_name with TheShortDuck customization"
   ...
   case "$choice" in
        1)
            ...
            ;;
        2)
            echo "Installing $wm_name with TheShortDuck customization..."
            ;;
        *)
